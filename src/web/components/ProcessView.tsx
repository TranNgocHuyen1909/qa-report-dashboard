export function ProcessView({ view }: { view?: any }) {
  return (
    <div className="process-view animate-fade-in" style={{ paddingBottom: "32px", display: "flex", flexDirection: "column", gap: "20px" }}>
      ...
      >
        <div style={{ fontSize: "16px", fontWeight: "800", color: "var(--text)", marginBottom: "16px", display: "flex", alignItems: "center", gap: "8px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gap: "10px", marginBottom: "20px" }}>
          ...
          <div style={{ background: "var(--surface-2)", padding: "12px", borderRadius: "8px", border: "1px solid var(--border-3)", position: "relative" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "6px" }}>
              <span style={{ width: "22px", height: "22px", borderRadius: "50%", background: "var(--text-2)", color: "#fff", fontWeight: "bold", fontSize: "11px", display: "flex", alignItems: "center", justifyContent: "center" }}>1</span>
              <span className="process-step-label">Notion</span>
            </div>
            ...
            <div style={{ fontSize: "11px", color: "var(--text-2)", lineHeight: "1.4" }}>
              Nhận assign defect. Đổi status Notion sang <strong style={{ color: "var(--text-2)" }}>Doing</strong>. Hủy ngay nếu trùng/không rảnh.
            </div>
          </div>
          ...
          <div style={{ background: "var(--surface-2)", padding: "12px", borderRadius: "8px", border: "1px solid var(--border-3)" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "6px" }}>
              <span style={{ width: "22px", height: "22px", borderRadius: "50%", background: "var(--text-2)", color: "#fff", fontWeight: "bold", fontSize: "11px", display: "flex", alignItems: "center", justifyContent: "center" }}>2</span>
              <span className="process-step-label">Analysis</span>
            </div>
          ...
          <div style={{ background: "var(--surface-2)", padding: "12px", borderRadius: "8px", border: "1px solid var(--border-3)" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "6px" }}>
              <span style={{ width: "22px", height: "22px", borderRadius: "50%", background: "var(--text-2)", color: "#fff", fontWeight: "bold", fontSize: "11px", display: "flex", alignItems: "center", justifyContent: "center" }}>3</span>
              <span className="process-step-label">Code &amp; Test</span>
            </div>
          ...
          <div style={{ background: "var(--surface-2)", padding: "12px", borderRadius: "8px", border: "1px solid var(--border-3)" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "6px" }}>
              <span style={{ width: "22px", height: "22px", borderRadius: "50%", background: "var(--text-2)", color: "#fff", fontWeight: "bold", fontSize: "11px", display: "flex", alignItems: "center", justifyContent: "center" }}>4</span>
              <span className="process-step-label">GitHub</span>
            </div>
            <div style={{ fontSize: "12px", fontWeight: "bold", color: "var(--text-1)", marginBottom: "4px" }}>Tạo PR &amp; Dán PR URL</div>
            <div style={{ fontSize: "11px", color: "var(--text-2)", lineHeight: "1.4" }}>
              Tạo PR GitHub, copy PR URL dán vào Notion. Đổi status ➔ <strong style={{ color: "var(--text-2)" }}>Resolved (Chờ Review)</strong>.
            </div>
          </div>
          ...
          <div style={{ background: "var(--surface-2)", padding: "12px", borderRadius: "8px", border: "1px solid var(--border-3)" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "6px" }}>
              <span style={{ width: "22px", height: "22px", borderRadius: "50%", background: "var(--text-2)", color: "#fff", fontWeight: "bold", fontSize: "11px", display: "flex", alignItems: "center", justifyContent: "center" }}>5</span>
              <span className="process-step-label">Review</span>
            </div>
          ...
          <div style={{ background: "var(--surface-2)", padding: "12px", borderRadius: "8px", border: "1px solid var(--border-3)" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "6px" }}>
              <span style={{ width: "22px", height: "22px", borderRadius: "50%", background: "var(--text-2)", color: "#fff", fontWeight: "bold", fontSize: "11px", display: "flex", alignItems: "center", justifyContent: "center" }}>6</span>
              <span className="process-step-label">Done</span>
            </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
          ...
          <div style={{ background: "var(--surface-2)", padding: "14px", borderRadius: "8px", border: "1px solid var(--border-3)" }}>
            <div style={{ fontSize: "13px", fontWeight: "bold", color: "var(--text)", marginBottom: "8px", display: "flex", alignItems: "center", gap: "6px" }}>
            ...
            <ul style={{ margin: 0, paddingLeft: "16px", fontSize: "11px", color: "var(--text-2)", display: "flex", flexDirection: "column", gap: "6px", lineHeight: "1.5" }}>
              ...
              <li>
                <strong style={{ color: "var(--text-2)" }}>Doing:</strong> Dev nhận assign và bắt đầu phân tích / sửa code (Chỉ chuyển sang Doing khi thực sự làm).
              </li>
              <li>
                <strong style={{ color: "var(--text-2)" }}>Resolved (Chờ Review):</strong> Đã sửa xong code, đã tự test 6 bước và <strong>BẮT BUỘC PHẢI DÁN PR URL</strong> vào card Notion.
              </li>
              <li>
                <strong style={{ color: "var(--text-2)" }}>Ready for Test / Deployed:</strong> Code đã merge, đã deploy lên server chạy thử nghiệm.
              </li>
              <li>
          ...
          <div style={{ background: "var(--surface-2)", padding: "14px", borderRadius: "8px", border: "1px solid var(--border-3)" }}>
            ...
            <ul style={{ margin: 0, paddingLeft: "16px", fontSize: "11px", color: "var(--text-2)", display: "flex", flexDirection: "column", gap: "6px", lineHeight: "1.5" }}>
              ...
              <li>
                <strong style={{ color: "var(--text-1)" }}>Hủy bug trùng sớm:</strong> Bug trùng lặp hoặc không tái hiện phải HỦY (Cancel) ngay từ đầu, không kéo dài để tránh sai lệch nỗ lực.
              </li>
            </ul>
          </div>
      ...
      <div className="manager-dashboard-layout">
        ...
        <div className="card">
          <div className="card-header" style={{ marginBottom: "12px", borderBottom: "1px solid var(--border-3)", paddingBottom: "6px" }}>
            <div className="card-title">⏱️ 2. Năng lực Ước Lượng (Estimate)</div>
          </div>
          ...
          <div style={{ marginTop: "12px", display: "flex", flexDirection: "column", gap: "8px" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", background: "var(--surface-2)", padding: "8px 12px", borderRadius: "6px" }}>
              ...
              <span className="tag tag-gray">🎯 ~70% Acc</span>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", background: "var(--surface-2)", padding: "8px 12px", borderRadius: "6px" }}>
              <div>
              ...
              <span className="tag tag-gray">🎯 &gt;=80% Acc</span>
            </div>
          </div>
